...
const kpis = [
  { label: "Asked for you", value: "3", change: "+1", status: "up" },
  {
    label: "Live sources",
    value: "3",
    change: "of 6",
  ...
  { label: "Approvals", value: "2", change: "+2", status: "down" },
];
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h4 className="font-bold text-zinc-900">City size, not district</h4>
                </div>
                <p className="text-sm text-zinc-500">
                  You read this brand by city size. Small towns are up{" "}
                  <span className="text-zinc-900 font-semibold">2.7 pts</span>
                  , measured now.
                </p>
              </TimelineAnimation>
            </div>
